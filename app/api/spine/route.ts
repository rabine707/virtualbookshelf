...
export async function GET(request: Request) {
  ...
  try {
    ...
    // A book spine is a narrow detail crop of the approved front-cover artwork.
    ...
    // Title and author are rendered separately in the browser so typography is
    // always readable and never needs to be generated by an image model.
...
<svg xmlns="http://www.w3.org/2000/svg" width="${SPINE_WIDTH}" height="${SPINE_HEIGHT}" viewBox="0 0 ${SPINE_WIDTH} ${SPINE_HEIGHT}">
  ...
  <rect x="3" y="2" width="294" height="1496" rx="12" fill="none"
