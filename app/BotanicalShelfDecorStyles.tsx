...
/**
 * Canonical Botanical shelf-decor layer.
 *
 * This combines the former prop and lamp-fix style components in their original
 * cascade order. Keep shelf prop geometry and lamp treatment here so later
 * design-system work has one predictable decor authority to override.
 */
export default function BotanicalShelfDecorStyles() {
  return <style>{`
    ...
    /* Glow base. The canonical lamp treatment below intentionally overrides it. */
    ...
    /* Canonical lamp correction (formerly a separate late override component). */
    html[data-shelf-theme="botanical"] .botanical-row-decor-warm-glow::before {
      width: 104px !important;
