...
export default function CloudAccountSettings() {
  ...
  return createPortal(<>
    ...
    <section className="cloud-account-card">
      <header><div><small>SHELF CLOUD</small><h2>Sync, rewards & sharing</h2><p>Your library, theme, artwork choices and rewards now follow your account.</p></div><span className="cloud-sync-badge">● Sync on</span></header>
